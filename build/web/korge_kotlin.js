(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'korge_kotlin'.");
    }if (typeof this['korge-root-korge'] === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'korge-root-korge' was not found. Please, check whether 'korge-root-korge' is loaded prior to 'korge_kotlin'.");
    }if (typeof this['korim-root-korim'] === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'korim-root-korim' was not found. Please, check whether 'korim-root-korim' is loaded prior to 'korge_kotlin'.");
    }if (typeof this['korma-root-korma'] === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'korma-root-korma' was not found. Please, check whether 'korma-root-korma' is loaded prior to 'korge_kotlin'.");
    }if (typeof this['korio-root-korio'] === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'korio-root-korio' was not found. Please, check whether 'korio-root-korio' is loaded prior to 'korge_kotlin'.");
    }if (typeof this['klock-root-klock'] === 'undefined') {
      throw new Error("Error loading module 'korge_kotlin'. Its dependency 'klock-root-klock' was not found. Please, check whether 'klock-root-klock' is loaded prior to 'korge_kotlin'.");
    }root.korge_kotlin = factory(typeof korge_kotlin === 'undefined' ? {} : korge_kotlin, kotlin, this['korge-root-korge'], this['korim-root-korim'], this['korma-root-korma'], this['korio-root-korio'], this['klock-root-klock']);
  }
  ...
  Kotlin.defineModule('korge_kotlin', _);
  return _;
}));

//# sourceMappingURL=korge_kotlin.js.map
